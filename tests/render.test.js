...
describe("renderAmiiboList", () => {
  ...
  it("should render amiibo list", () => {
    const amiibos = [
      { name: "Mario", image: "mario.png", head: "1234", tail: "5678" },
    ];
...
describe("renderAmiiboDetails", () => {
  ...
  it("should render amiibo details in the detailsView element", () => {
    ...
    expect(detailsView.innerHTML).toContain(
      '<img src="https://example.com/mario.png" alt="Mario">'
    );
    expect(detailsView.innerHTML).toContain(
      "<strong>Game Series:</strong> Super Mario"
    );
    expect(detailsView.innerHTML).toContain(
      "<strong>Character:</strong> Mario"
    );
